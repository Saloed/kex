...
class DebugStatementOperation(
        ...
        private val declaredPredicates: List<FuncDecl>
) : StatementOperation {
...
abstract class StatementBuilder(private val ctx: Z3FixpointSolver.CallCtx, private val stateInternal: BoolExpr, val declarations: List<Expr>) {
    open fun declaredPredicates() = emptyList<FuncDecl>()
    ...
    fun debug() = StatementBuilderExecutor(DebugStatementOperation(ctx, stateInternal, declarations, declaredPredicates()), this)
}
