...
@InheritorOf("Term")
@Serializable
class ArrayLengthTerm(override val type: KexType, val arrayRef: Term, override val memoryVersion: MemoryVersion = MemoryVersion.default()) : Term(), MemoryAccess<ArrayLengthTerm> {
    ...
    override fun withMemoryVersion(memoryVersion: MemoryVersion) = ArrayLengthTerm(type, arrayRef, memoryVersion)
